...
class User extends Authenticatable implements CanSendOTPContract
{
     ...
     */
    protected $fillable = [
        'date_of_birth','city','gender','gender_based_search','rating_average','no_of_rating','total_rating','name', 'username', 'email', 'password', 'mobile', 'country', 'profile_picture', 'email_confirmed', 'mobile_confirmed', 'email_confirmation_token', 'active','device_token','login_by'
    ];
