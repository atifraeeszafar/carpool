...
class ComplaintsController extends BaseController
{
    ...
    */
    ...
    {
        $page = trans('pages_names.add_complaints');
        ...
        return view('admin.complaints.create', compact('page','main_menu', 'sub_menu'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $message = trans('succes_messages.complaints_added_succesfully');
    ...
    {
        $page = trans('pages_names.edit_complaints');
        ...
        return view('admin.complaints.update', compact('page','main_menu', 'sub_menu'));
    }
    ...
    public function update(Request $admin, Request $request)
    {
        ...
        $message = trans('succes_messages.complaints_updated_succesfully');
        return redirect('complaints')->with('success', $message);
    }
