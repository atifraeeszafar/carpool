...
class PromoCodeController extends BaseController
{
    ...
    */
    ...
    {
        $page = trans('pages_names.promocode');

        $main_menu = 'promocode';
        $sub_menu = null;

        return view('admin.promocode.index', compact('page', 'main_menu', 'sub_menu'));
    }
    ...
    public function fetch(QueryFilterContract $queryFilter)
    {
        ...
        return view('admin.promocode._promocode', compact('results'));
    }

    public function create()
    {
        $page = trans('pages_names.add_promocode');
        ...
        return view('admin.promocode.create', compact('page','main_menu', 'sub_menu'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('promocode')->with('success', $message);
    }


    public function getById(Request $admin)
    {
        $page = trans('pages_names.edit_promocode');
        ...
        return view('admin.promocode.update', compact('page','main_menu', 'sub_menu'));
    }
