...
class TranslationController extends BaseController
{
    ...
    */
    public function index()
    {
        ...
        $get_api_key = 'AIzaSyDUyEIiENcv6OCDELgu0o272IjpRNOQilQ';

        $response = $client->get('https://sheets.googleapis.com/v4/spreadsheets/1KztbVsh5RrVvG67kQWuRxFTe5dkL_mVO0nel1wioyrs/values:batchGet?ranges=Settings!A:Z&key='.$get_api_key.'&ranges=Sheet1!A:Z');
