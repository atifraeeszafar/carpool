            ...
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <ul class="nav nav-tabs" style="padding: 1rem">
                        ...
                        <li class="nav-item">
                            <a href="#{{$setting_key}}" data-toggle="tab" aria-expanded="false" class="nav-link <?php if($tab==1){echo "active"; }?>"> {{trans('view_pages.'.$setting_key)}}
                            </a>
                        </li>
                        <?php $tab++;} ?>
                    ...
                    <div class="tab-content p-10">
                        ...
                        <div class="tab-pane show <?php if($tab==1){echo "active"; }?>" id="{{$setting_key}}">
                      ...
                      /*image box*/     elseif($setting_name['field']=="file"){ ?>
                                        <div class="imageupload panel panel-default">
                                            <div class="file-tab panel-body">
                                                <?php if($setting_name['value'] != "" && $setting_name['value'] != null){ ?>
                                                <img src="<?php echo url_info().'admin/logo/'.$setting_name['value'];?>" alt="Image preview" class="default_thumbnail" style="max-width: 250px; max-height: 250px">
                                                <?php } ?>
                                                <br>
                                                <label class="btn btn-custom btn-file">
                                                    <span>{{trans('view_pages.browse')}}</span>
                                                    <!-- The file is stored here. -->

                                                    <input name="<?=$setting_name['name'];?>" type="file">
                                                </label>
                                                <button type="button" class="btn btn-danger" style="margin-bottom: 0.5rem; display: none;">{{trans('view_pages.remove')}}</button>
                                            </div>
                                        </div>
                                        <?php }
