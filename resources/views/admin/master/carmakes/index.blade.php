...
<div class="col-md-8">
<h4 class="page-title mb-1">CarMakes</h4>
...
<td>{{$result->name}}</td>
<td>
<a class="btn btn-primary btn-sm" href="{{url('carmakes/edit',$result->id)}}">
<i class="far fa-edit" id = "edit_session" data-toggle="tooltip" data-placement="top" title="Edit"></i>
</a>
<a class="btn btn-primary btn-sm" href="{{url('carmakes/delete',$result->id)}}">
