...
<div class="card">
<div class="card-body">
<h4 class="header-title">{{trans('pages_names.cancellation')}}</h4>
<p class="card-title-desc">Cancellation of the system to be listed.</p>
        ...
        <div class="row text-right">
            ...
            <div class="col-9 text-right">
                <a href="{{url('cancellation/create')}}" class="btn btn-primary btn-sm">
                    <i class="mdi mdi-plus-circle mr-2"></i>@lang('view_pages.add_cancellation')</a>
