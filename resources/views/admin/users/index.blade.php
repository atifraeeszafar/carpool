...
<div class="card">
<div class="card-body">
<h4 class="header-title">{{trans('pages_names.users')}}</h4>
<p class="card-title-desc">Users of the system to be listed.</p>
        ...
        <div class="row text-right">
            ...
            <div class="col-9 text-right">
                <a href="{{url('user/create')}}" class="btn btn-primary btn-sm">
                    <i class="mdi mdi-plus-circle mr-2"></i>@lang('view_pages.add_users')</a>
...
<div id="js-admin-partial-target">
    <include-fragment src="user/fetch">
