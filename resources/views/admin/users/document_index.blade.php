...
<div class="card">
<div class="card-body">
<h4 class="header-title">{{trans('pages_names.users')}} {{trans('pages_names.document')}}</h4>
<p class="card-title-desc">Document of the Users to be listed.</p>
        ...
        <div class="row text-right">
            ...
            <div class="col-9 text-right">
                <!-- <a href="{{url('user/create')}}" class="btn btn-primary btn-sm">
                    <i class="mdi mdi-plus-circle mr-2"></i>@lang('view_pages.add_users')
                </a> -->
            </div>
        </div>
        </div>
<div id="js-admin-partial-target">
    <include-fragment src="list/fetch/{{$user->id}}">
...
$('#search').on('click', function(e){
    e.preventDefault();
        ...
        fetch('user/fetch?search='+search_keyword)
