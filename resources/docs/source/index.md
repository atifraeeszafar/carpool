...
```bash
curl -X GET \
    -G "http://localhost/car-pool/public/api/v1/common/faq/list" \
    -H "Authorization: Bearer: {token}"
```

```javascript
const url = new URL(
    "http://localhost/car-pool/public/api/v1/common/faq/list"
);
...
```bash
curl -X GET \
    -G "http://localhost/car-pool/public/api/v1/common/sos/list" \
    -H "Authorization: Bearer: {token}"
```

```javascript
const url = new URL(
    "http://localhost/car-pool/public/api/v1/common/sos/list"
);
